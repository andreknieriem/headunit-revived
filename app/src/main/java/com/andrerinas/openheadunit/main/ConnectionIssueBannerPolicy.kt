...
object ConnectionIssueBannerPolicy {
     ...
     * [relevantNow] already answers. `HOTSPOT_NOT_RUNNING`, `WIFI_DIRECT_GROUP_REFUSED` and
     * `WIFI_DIRECT_STACK_CYCLED` have none either: no setting fixes them, and an access point coming
     * up or a group forming disproves them outright, so those records retire themselves.
     *
